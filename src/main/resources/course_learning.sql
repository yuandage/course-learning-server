...
-- Records of course
-- ----------------------------
INSERT INTO `course` VALUES ('1', 'C语言', '二级C语言', '很多的目录', '21', NULL, 'https://img1.mukewang.com/szimg/5e26a9f909ef95b512000676-360-202.png', '2019-09-18 16:16:22', '2019-09-18 16:16:25');
...
INSERT INTO `course` VALUES ('71', '微机原理与接口技术', '微机原理与接口技术简介', '这是目录', '71', '1', 'https://img2.sycdn.imooc.com/szimg/5dce41e70819b56b06000338-360-202.jpg', '2019-09-26 15:21:11', '2019-09-26 15:21:14');
...
CREATE TABLE `course_classification`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '学科' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of course_classification
-- ----------------------------
INSERT INTO `course_classification` VALUES (1, '计算机等级考试', NULL);
INSERT INTO `course_classification` VALUES (2, '前端语言程序设计', NULL);
INSERT INTO `course_classification` VALUES (3, '后端语言程序设计', NULL);
INSERT INTO `course_classification` VALUES (4, '数据结构与算法分析', NULL);
INSERT INTO `course_classification` VALUES (5, '数据库设计', NULL);
INSERT INTO `course_classification` VALUES (6, '计算机基础', NULL);
INSERT INTO `course_classification` VALUES (21, '二级C语言', 1);
INSERT INTO `course_classification` VALUES (22, '二级Office', 1);
INSERT INTO `course_classification` VALUES (23, '三级数据库', 1);
INSERT INTO `course_classification` VALUES (24, '三级网络', 1);
INSERT INTO `course_classification` VALUES (25, '三级信息安全', 1);
INSERT INTO `course_classification` VALUES (26, '四级网络工程师', 1);
INSERT INTO `course_classification` VALUES (27, '四级数据库工程师', 1);
INSERT INTO `course_classification` VALUES (28, '四级信息安全工程师', 1);
INSERT INTO `course_classification` VALUES (31, 'HTML/CSS', 2);
INSERT INTO `course_classification` VALUES (32, 'JavaScript', 2);
INSERT INTO `course_classification` VALUES (34, 'Node.js', 2);
INSERT INTO `course_classification` VALUES (35, 'Vue.js', 2);
INSERT INTO `course_classification` VALUES (41, 'C语言程序设计', 3);
INSERT INTO `course_classification` VALUES (42, 'C++语言程序设计', 3);
INSERT INTO `course_classification` VALUES (43, 'JAVA语言程序设计', 3);
INSERT INTO `course_classification` VALUES (51, '数据结构', 4);
INSERT INTO `course_classification` VALUES (52, '算法分析与实现', 4);
INSERT INTO `course_classification` VALUES (61, '数据库基础', 5);
INSERT INTO `course_classification` VALUES (71, '微机原理与接口技术', 6);
...
-- ----------------------------
INSERT INTO `course_comment` VALUES ('1227783921161342976', NULL, '6', NULL, NULL, '唐小燕', 'if 后面没有 括号，则if 只包含下一行。 那这样这个 compare 函数，就有可能没有返回值。 在 11 行下面，再加一行 return true ; 即可。', NULL, NULL, NULL, NULL);
INSERT INTO `course_comment` VALUES ('1227784338473619456', NULL, '6', NULL, NULL, '袁大哥', '这门课程感觉好流弊啊', NULL, NULL, NULL, NULL);
INSERT INTO `course_comment` VALUES ('1227784387597307904', NULL, '6', NULL, NULL, '张超', '告诉大家一个白嫖的好方法，只要你用流量打开视频，注意！千万别点播放，完事点缓存再暂停，接着打开缓存页面用WiFi下载，看完删了就行，不仅不用投币点赞，甚至连播放量都不给[doge][doge][doge][doge]', NULL, NULL, NULL, NULL);
INSERT INTO `course_comment` VALUES ('1227784456794935296', NULL, '6', NULL, NULL, '杨忠学', '纯路人，第一次下载这个软件，看到首页推荐了这个视频，这就是B站的氛围吗，i了i了。', NULL, NULL, NULL, NULL);
INSERT INTO `course_comment` VALUES ('1227784934169645056', NULL, '6', NULL, NULL, '吴世龙', '这些片段当时是舞法天女新一季的其中一些片段，但由于被指抄袭和对儿童未来的发展和教育不利，所以被有关部门叫停制作并停止播放，我当时有幸看到过这些片段，如今能在这里看到，爷非常高兴', NULL, NULL, NULL, NULL);
...
INSERT INTO `course_comment` VALUES ('1237304999965495296', '1234119223710715901', '71', NULL, NULL, 'admin', '666', NULL, '2020-03-14 22:10:30', NULL, NULL);
...
-- ----------------------------
INSERT INTO `course_question` VALUES ('1', '71', NULL, NULL, '单选题', '8086CPU 芯片的外部引线中，数据线的条数为？', 'A、6条#B、8条#C、16条#D、20条', '3', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('10', '71', NULL, NULL, '单选题', 'CPU 对存储器或 I/O 端口完成一次读/写操作所需的时间为一个？', 'A、指令周期#B、总线周期#C、时钟周期#D、机器周期', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('2', '71', NULL, NULL, '单选题', '8088CPU 上 READY 信号为下面哪种信号有效？', 'A、上升沿#B、下降沿#C、高电平#D、低电平', '3', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('21', '71', NULL, NULL, '判断题', '软件与硬件的等价性原理说明软硬件在功能、性能和成本等方面是等价的。', 'A、正确#B、错误', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('22', '71', NULL, NULL, '判断题', 'IA-64结构是IA-32结构的64位扩展，也就是Intel 64结构。', 'A、正确#B、错误', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('23', '71', NULL, NULL, '判断题', '8086的数据总线为16位，也就是说8086的数据总线的个数或者说条数、位数是16。', 'A、正确#B、错误', '1', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('24', '71', NULL, NULL, '判断题', '微机主存只要使用RAM芯片就可以了。', 'A、正确#B、错误', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('25', '71', NULL, NULL, '判断题', '处理器并不直接连接外设，而是通过I/O接口电路与外设连接。', 'A、正确#B、错误', '1', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('26', '71', NULL, NULL, '判断题', '处理器是微机的控制中心，内部只包括5大功能部件的控制器。', 'A、正确#B、错误', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('27', '71', NULL, NULL, '判断题', 'Windows的模拟DOS环境与控制台环境是一样的。', 'A、正确#B、错误', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('28', '71', NULL, NULL, '判断题', '16位IBM PC/AT采用ISA系统总线。', 'A、正确#B、错误', '1', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('29', '71', NULL, NULL, '判断题', 'IA-32处理器吸取了RISC技术特长。RISC是指复杂指令集计算机。', 'A、正确#B、错误', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('3', '71', NULL, NULL, '单选题', '8088CPU 中的 CS 寄存器是一个多少位的寄存器？', 'A、8位#B、16位#C、24位#D、32位', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('30', '71', NULL, NULL, '判断题', '处理器进行读操作，就是把数据从处理器内部读出传送给主存或外设。', 'A、正确#B、错误', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('4', '71', NULL, NULL, '单选题', '属于只读存贮器的芯片是？', 'A、SRAM#B、DRAM#C、EPROM#D、SDRAM', '3', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('5', '71', NULL, NULL, '单选题', '内存从 A4000H 到 CBFFFH，共有？', 'A、124K#B、160K#C、180K#D、224K', '2', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('6', '71', NULL, NULL, '单选题', '擦除 EPROM 是用？', 'A、＋5V 电压#B、＋15V 电压#C、＋21V 电压#D、紫外光照射', '4', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('7', '71', NULL, NULL, '单选题', '采用查询方式来实现输入输出是因为它？', 'A、速度最快#B、实现起来比较容易#C、CPU 可以不介入#D、在对多个事件查询工作时，能对突发事件做出实时响应', '3', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('8', '71', NULL, NULL, '单选题', '实 现 DMA传 送 ， 需 要？', 'A、CPU 通过执行指令来完成#B、CPU 利用中断方式来完成#C、CPU 利用查询方式来完成#D、不需要 CPU 参与即可完成', '4', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_question` VALUES ('9', '71', NULL, NULL, '单选题', '堆栈指针的作用是用来指示？', 'A、栈底地址#B、栈顶地址#C、下一条要执行指令的地址#D、上一条要执行指令的地址', '2', NULL, NULL, NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `course_question_comment` VALUES ('1235559357018673152', '1234119223710715904', '71', '1', 'yh', '666', NULL, NULL, NULL, NULL);
...
INSERT INTO `course_question_comment` VALUES ('1235559436815306752', '1234119223710715904', '71', '1', 'yh', '这么牛逼的吗', NULL, NULL, NULL, NULL);
INSERT INTO `course_question_comment` VALUES ('1235559516536442880', '1234119223710715904', '71', '1', 'yh', '这道题要怎么做?', NULL, NULL, NULL, NULL);
INSERT INTO `course_question_comment` VALUES ('1235571165540519936', '1234119223710715904', '71', '9', 'yh', '这道题怎么做啊?', NULL, NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `course_resource` VALUES ('1234509443093991424', '71', '第01章  接口概述', 'PPT', NULL, 'http://localhost:9000/resource/download/1234509443093991424', NULL, '2020-03-05 18:16:21', NULL, '2020-03-05 18:16:21');
INSERT INTO `course_resource` VALUES ('1235498042191384576', '71', '第02章  处理器结构', 'PPT', NULL, 'http://localhost:9000/resource/download/1235498042191384576', NULL, '2020-03-05 17:31:02', NULL, '2020-03-05 17:31:02');
INSERT INTO `course_resource` VALUES ('1235498139981582336', '71', '第05章  微机总线', 'PPT', NULL, 'http://localhost:9000/resource/download/1235498139981582336', NULL, '2020-03-05 17:31:26', NULL, '2020-03-05 17:31:26');
INSERT INTO `course_resource` VALUES ('1235498247519342592', '71', '第06章  存储系统', 'PPT', NULL, 'http://localhost:9000/resource/download/1235498247519342592', NULL, '2020-03-05 17:31:51', NULL, '2020-03-05 17:31:51');
INSERT INTO `course_resource` VALUES ('1235498367149281280', '71', '第07章  输入输出接口', 'PPT', NULL, 'http://localhost:9000/resource/download/1235498367149281280', NULL, '2020-03-05 17:32:20', NULL, '2020-03-05 17:32:20');
...
CREATE TABLE `course_video`  (
  ...
  `url` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '视频链接',
  `create_user` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间 ',
  `update_user` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
...
-- ----------------------------
INSERT INTO `course_video` VALUES ('1238865441192022016', '1', 'nb的视频', '这个视频真好看', '8:00', NULL, 'string', NULL, NULL, NULL, NULL);
INSERT INTO `course_video` VALUES ('1238865502462414848', '1', 'nb的视频111', '这个视频真好看', '8:00', NULL, 'string', NULL, NULL, NULL, NULL);
INSERT INTO `course_video` VALUES ('1238865542547378176', '1', 'nb的视频222', '这个视频真好看', '8:00', NULL, 'string', NULL, NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `permission` VALUES ('1', 'find', '查询', NULL, NULL, NULL, NULL);
INSERT INTO `permission` VALUES ('2', 'add', '添加', NULL, NULL, NULL, NULL);
INSERT INTO `permission` VALUES ('3', 'update', '更新', NULL, NULL, NULL, NULL);
INSERT INTO `permission` VALUES ('4', 'delete', '删除', NULL, NULL, NULL, NULL);
INSERT INTO `permission` VALUES ('5', 'upload', '上传', NULL, NULL, NULL, NULL);
INSERT INTO `permission` VALUES ('6', 'download', '下载', NULL, NULL, NULL, NULL);
...
INSERT INTO `role` VALUES ('6', 'visitor', '访客', NULL, NULL, NULL, NULL);
...
INSERT INTO `role_permission` VALUES ('1238360474484084736', '5', '6', NULL, NULL, NULL, NULL);
...
INSERT INTO `role_permission` VALUES ('15', '1', '6', NULL, NULL, NULL, NULL);
...
INSERT INTO `role_permission` VALUES ('25', '2', '6', NULL, NULL, NULL, NULL);
...
INSERT INTO `role_permission` VALUES ('35', '3', '6', NULL, NULL, NULL, NULL);
...
INSERT INTO `role_permission` VALUES ('42', '4', '6', NULL, NULL, NULL, NULL);
...
INSERT INTO `role_permission` VALUES ('60', '6', '1', NULL, NULL, NULL, NULL);
...
INSERT INTO `user` VALUES ('1234119223710715906', 'vistor', '18608212510', '$2a$10$ogqzDygYCQ72KhHw5lblpubKVenDHR8e6wbZDa7/lX/tSmRSajOd.', '访客', '男', NULL, NULL, '1027928543@qq.com', '2020-03-01 22:12:07', '2020-03-01 22:12:07', '2020-03-01 22:12:07', 0, NULL, NULL, 0, 0);
...
INSERT INTO `user_role` VALUES ('1238360255344283648', '1234119223710715906', '6', NULL, NULL, NULL, NULL);
